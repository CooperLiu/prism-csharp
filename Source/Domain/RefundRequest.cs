...
namespace Prism.Domain
{
    public class RefundRequest
    {
        ...
        /// <summary>
        /// 当 refund_type 的值为        refund 时，退款单状态，可选值： SUCC:支付成 功, FAILED:支付失败,CANCEL:未支付,ERROR:参数异常,INVALID:校验错误,PROGRESS:处理中,TIMEOUT:超时, READY:准备中；当refund_type 的值为apply 时，退款申请单状态： APPLY:退款申请,VERIFY:审核中, SUCC:审核通过, REFUND:已退 款, FAIL:审核不通过
        /// </summary>
